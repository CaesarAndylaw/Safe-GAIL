    ...
    if multiple:
        for othid in trajinfos[traj_idx].keys():
            ...
            if oth_ts <= ts_ and te_ <= oth_te:
                ...
                egoids.add(othid)
    n_veh = len(egoids)
    # print("we currently smapled n_veh for egoids: ", n_veh)
...
def print_safety(error: dict):
    phi_overall = np.array(error["phi_overall"])
    print("========================================================================================================")
    print("overall safety index: {}".format(phi_overall))
    print("========================================================================================================\n")
