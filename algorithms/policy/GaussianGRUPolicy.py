...
class GaussianGRUPolicy(nn.Module):
    ...
    def get_actions(self, observations):
        ...
        rnd = np.array([[0.02249256, 0.0814186]])
        # rnd = np.array([[-0.35017435, 0.08431689]])
        # rnd = np.array([[-0.1017435, 0.28431689]])
        # rnd = np.array([[0.21026437, 0.35660283]])
        # print("ayaya the random seed is:", rnd)
        # time.sleep(1)
