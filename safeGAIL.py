...
def online_adaption(
    ...
    for step in tqdm.tqdm(range(ego_start_frame, ego_start_frame+1)):  #test one step
        ...
        # get an action the use rls to adapt
...
def rollout(x, adapnets, env, policy, prev_hiddens, n_agents, adapt_steps, control, maxstep):
    ...
    for j in range(predict_span):
        ...
        # print("============ load Xr state =============")
        posx, posy, postheta, posv = env.veh_state()
        ...
        # print("relative velocity:", x[0][64])
        # print("relative distance:", x[0][63])
        # print("fx=:", fx)
        # print("fu=:", fu)
        # print("dot_Xh=:", dot_Xh)
        # print("Mr=:", Mr)
        # print("Mh=:", Mh)
        # print("p_Mr_p_Xr=:", p_Mr_p_Xr)
        # print("p_Mh_p_Xh=:", p_Mh_p_Xh)
        # print("a=:", a)
        ...
        if poshx == 0. and poshy == 0. and poshtheta == 0. and poshv == 0.: # there is no front car
            ...
            a = np.asmatrix(a)
            print("the distance to front car is:", x[0][63])
            ...
            action = a_new
            # print("new action=:", a_new)
        # sys.exit("Checking terminated")
        ...
        # print("predicted v:", e_info["v"][0])
        # print("orig theta: ", e_info["orig_theta"][0])
        # print("predicted x: ", e_info["x"][0])
        # print("predicted y: ", e_info["y"][0])
        # print("----------------------- step --------------------")
        if any(dones):
