...
class Roadway:
    ...
    def get_by_tag(self, tag: LaneTag):
        # print("the segment id is:", tag.segment)
        seg = self.get_by_id(tag.segment)
        # print(seg.id, len(seg.lanes), tag.lane)
        # print("the lane index in tag is:", tag.lane)
...
def proj_2(posG: VecSE2.VecSE2, roadway: Roadway):
    ...
    for seg in roadway.segments:
        # print("=============current seg id:{}===========".format(seg.id))
        for lane in seg.lanes:
            # print("current lane id:", lane.tag.lane)
            ...
            # print("the best_dist2, dist2, roadproj.curveproj.ind.i are: ",best_dist2, dist2, roadproj.curveproj.ind.i)
            if dist2 < best_dist2:
                best_dist2 = dist2
                best_proj = roadproj
    return best_proj
