...
def get_elapsed_time_3(rec: SceneRecord, pastframe_farthest_back: int, pastframe_most_recent: int):
    # print("the recent is {} and past is {} and time.step is {}".format(pastframe_most_recent, pastframe_farthest_back, rec.timestep))
    # sys.exit("end_checking!!")
...
def get_vehicle(rec: ListRecord, stateindex: int):
    ...
    # print("found vehicle id:", recstate.id)
...
def get_scene(frame: Frame, rec: ListRecord, frame_index: int):
    ...
    if frame_inbounds(rec, frame_index):
        ...
        # if frame_index > 50:
        #     sys.exit("frame exceed 50 xixi")
        # print("=============== current frame is:",frame_index)
        # print("frame low and frame hi are:", recframe.lo, recframe.hi)
